...
const Footer: React.FC = () => {
  ...
  return (
    ...
    <footer className="bg-grey text-white px-0 py-20 md:py-32 border-t border-white/10" role="contentinfo">
      <div className="max-w-100 mx-auto px-5 md:px-10 lg:px-20">
