      ...
      <div className="relative max-w-400 mx-auto">
        ...
        >
          ...
          <button
            ...
            className="group inline-flex items-center gap-3 bg-yellow hover:bg-hover text-grey font-bold text-4 md:text-5 mx-auto px-5 py-4 rounded-sm transition-all duration-500 hover:shadow-[0_8px_30px_rgba(227,178,20,0.3)] hover:translate-y-[-2px]"
