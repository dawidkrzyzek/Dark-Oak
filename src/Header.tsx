      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-[90rem] mx-auto">
        ...
        >
          ...
          <a
            ...
            className="group inline-flex items-center justify-center gap-3 bg-yellow hover:bg-hover text-grey font-bold text-4 md:text-5 px-20 md:px-12 py-4 md:py-5 rounded-sm transition-all duration-500 hover:shadow-[0_8px_30px_rgba(227,178,20,0.4)] hover:translate-y-[-2px]"
